...
var RefFilterTableBaseUI = function (_Component) {
    _inherits(RefFilterTableBaseUI, _Component);

    //激活页码
    //总页数
    //表头数据
    function RefFilterTableBaseUI(props) {
        _classCallCheck(this, RefFilterTableBaseUI);
    ...
    RefFilterTableBaseUI.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    ...
    RefFilterTableBaseUI.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
        var _this3 = this;
    ...
    /** end:表格操作*/
    RefFilterTableBaseUI.prototype.render = function render() {
        var _this4 = this;
        ...
        var _props = this.props,
            ...
            _props$filterColumn = _props.filterColumn,
            filterColumn = _props$filterColumn === undefined ? [] : _props$filterColumn,
            ...
            _props$onFilterChange = _props.onFilterChange,
            onFilterChange = _props$onFilterChange === undefined ? function () {} : _props$onFilterChange,
            _props$onFilterClear = _props.onFilterClear,
            onFilterClear = _props$onFilterClear === undefined ? function () {} : _props$onFilterClear;
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                ...
                _react2["default"].createElement(_RefCoreTab2["default"], {
    ...
    // @ts-ignore
    RefFilterTableBaseUI.prototype.__reactstandin__regenerateByEval = function __reactstandin__regenerateByEval(key, code) {
        // @ts-ignore
        this[key] = eval(code);
    };

    return RefFilterTableBaseUI;
}(_react.Component);

var _default = RefFilterTableBaseUI;
...
(function () {
    ...
    reactHotLoader.register(RefFilterTableBaseUI, 'RefFilterTableBaseUI', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-filter-table/src/components/RefFilterTableBaseUI.js');
    reactHotLoader.register(_default, 'default', '/Users/yaoxin/Downloads/workspace/aacanzhao/tinper-acs/ref-filter-table/src/components/RefFilterTableBaseUI.js');
})();
